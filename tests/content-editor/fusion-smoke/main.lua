...
local function report(s) local f=assert(io.open(root.."/tests/content-editor/fusion-smoke/result.txt","w"));f:write(s);f:close() end
...
function love.load()
  ...
  dofile(root.."/tests/content-editor/test_gen3_fusion.lua")(data,root,lib.PHYSFS_mount,game)
  report("PASS: reversible fusion, both recipes, save reload, partner preservation and invalid operations")
  love.event.quit()
end
