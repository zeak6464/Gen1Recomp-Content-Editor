...
local function report(s) local f=assert(io.open(root.."/tests/content-editor/advanced-forms-smoke/result.txt","w"));f:write(s);f:close() end
...
function love.load()
  ...
  dofile(root.."/tests/content-editor/test_gen3_advanced_forms.lua")(data,root,lib.PHYSFS_mount,game)
  report("PASS: advanced form mechanics, battle activation, damage interception, HP and move restoration")
  love.event.quit()
end
