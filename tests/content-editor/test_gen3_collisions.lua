...
local source={cellWidth=10,cellHeight=1,layers={},baseTileset="native",
  gen3Border={width=0,height=0,mids={}},
  collision={"water","grass","ledge_right","ledge_left","ledge_up","ledge_down","door","walk","solid","water"},
  gen3Collision={[10]=0x29},gen3Elevation={[10]=7}}
local expected={0x29,0x18,0xA0,0xA1,0xA2,0xA3,0x71,0,255,0x29}
local expectedBeh={0x10,2,0x38,0x39,0x3A,0x3B,0x69,0,0,0}
